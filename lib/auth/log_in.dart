  ...
  Widget build(BuildContext context) {
    return Scaffold(backgroundColor: Colors.indigo.shade50,
        appBar: AppBar(backgroundColor: Colors.indigo.shade50,
          centerTitle:true,title: const Text("Log In",style: TextStyle(fontSize: 35,fontWeight: FontWeight.bold),),),
      body: Padding(
          ...
          child: Form(
            ...
            child: Column(children: [SizedBox(height: 200,width: 260,
              ...
              Padding(
                ...
                child: TextButton(onPressed: () {Navigator.push(context, MaterialPageRoute(builder: (context) => ForgotPasswordScreen(),));}, child: const Text("Forgot Password?",style: TextStyle(fontSize: 20),)),
              ),
              const SizedBox(height: 20,),
