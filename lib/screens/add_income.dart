...
import 'package:expense_tracker/screens/income_category.dart';
...
class _AddIncomeScreenState extends State<AddIncomeScreen> {
  ...
  Future<void> selectDate() async {
    ...
    if (pickedDate != null) {
      setState(() {
        provider.getDateController.text =
  ...
  Widget build(BuildContext context) {
    final provider = Provider.of<DataProvider>(context,listen: false);
      ...
      return PopScope(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(Get.arguments != null ? "Update Income" : "Add Income",
                ...
                child: Column(
                  children: [
                    ...
                    TextFormField(
                        ...
                        onFieldSubmitted: (v) {provider.getAmountController.text=v;},
                        ...
                        decoration: InputDecoration(
                            ...
                            prefixIcon: const Icon(
                              Icons.currency_rupee, color: Colors.black,),
                            filled: true,
                            fillColor: Colors.grey.shade400,
                            enabledBorder: OutlineInputBorder(
                                borderSide: const BorderSide(
                    ...
                    TextFormField(
                        ...
                        decoration: InputDecoration(
                            ...
                            prefixIcon: const Icon(
                              ...
                              Icons.date_range, color: Colors.black,),
                            filled: true,
                            fillColor: Colors.grey.shade400,
                            enabledBorder: OutlineInputBorder(
                                borderSide: const BorderSide(
                    ...
                    TextField(
                        ...
                        decoration: InputDecoration(
                            prefixIcon: const Icon(
                              Icons.abc, size: 33, color: Colors.black,),
                            filled: true,
                            fillColor: Colors.grey.shade400,
                            enabledBorder: OutlineInputBorder(
                                borderSide: const BorderSide(
